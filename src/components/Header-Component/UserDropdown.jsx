...
export default function UserDropdown() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        <div className={`rounded-3xl p-2 w-10 flex items-center justify-center transition-colors duration-200 
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-48 bg-gradient-to-tl from-stone-900 to-zinc-400 rounded-md shadow-lg py-1 z-10 border border-gray-200">
